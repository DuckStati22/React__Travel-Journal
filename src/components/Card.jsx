      ...
      <div className="card">
        ...
        <div className="card__info">
          <div className="card__info-geo">
            <p className="card__info-country">
            ...
            <a className="card__info-link" href={props.googleMapsUrl}>View on Google Maps</a>
          </div>
          <h2 className="card__info-title">{props.title}</h2>
          <p className="card__info-date">{props.startDate} - {props.endDate}</p>
          <p className="card__info-text">{props.description}</p>
        </div>
      </div>
      <hr />
    </div>
